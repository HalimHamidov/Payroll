...
{
    public class ServiceChargeTransactionParser : BaseTransactionTextParser
    {
        public ServiceChargeTransactionParser(IPayrollDatabase dbContext)
            : base(dbContext)
        {
        ...
        public override ITransaction Parse(String text)
        {
            ...
            ITransaction transaction = new ServiceChargeTransaction(employeeID, date, amount, _dbContext);
